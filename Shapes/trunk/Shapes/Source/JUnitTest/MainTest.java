...
public class MainTest extends TestSuite {
	...
	// The Eclipse preferences section General → Appearance → Editors → Text
	// Editors → Annotations allows to modify the visual representation of
	// coverage highlighting. The corresponding entries are:
	//
