...
import Input.CopyOfInputListener;
 ...
 * @version (0.1)
 */
public class CopyOfGameControllerAismael {
	 ...
	 */
	public CopyOfGameControllerAismael() {
		...
		//new Astroid();
		//new Astroid();
		Thread inputKeyController= new Thread(new CopyOfInputListener() {
		});
