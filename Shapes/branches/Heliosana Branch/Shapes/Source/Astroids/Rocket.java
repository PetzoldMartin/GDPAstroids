...
public class Rocket extends Sprite {
	...
	public Rocket(SpaceShip spaceShip) {
		double speed= (spaceShip.getAmount()+gameController.getMaxSpeed()/2+1);
		lifeTimeFrame=(int) (gameController.getGameScreenX()/(speed/2)+1);
		this.setVector(new Vector(spaceShip.getAmount()+gameController.getMaxSpeed()/2+1,spaceShip.getPhi()));
