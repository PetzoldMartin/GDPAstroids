...
public class VectorTest {
	...
	public void testChangeVectorPoint() {
		...
		assertEquals(
				"der Vector wurde bei Positiven Werten um einen Punkt nicht wie erwartet ver�ndert",
				new Vector(new Point(1, 1)), s1);
		s1.changeVector(new Point(-2, -2));
		assertEquals(
				"der Vector wurde bei Negativen Werten um einen Punkt nicht wie erwartet ver�ndert",
				new Vector(new Point(-1, -1)), s1);
	}
	...
	public void testGetPhi() {
		assertTrue(
				"Amount im 1. Quadranten wurde falsch berechnet " + s2.getPhi(),
				s2.getPhi() == 45);
		assertTrue(
				"Amount im 4. Quadranten wurde falsch berechnet " + s3.getPhi(),
				s3.getPhi() == -45);
		assertTrue(
				"Amount im 3. Quadranten wurde falsch berechnet " + s4.getPhi(),
				s4.getPhi() == -90 - 45);
		assertTrue(
